...
public class CactusPickaxeItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:cactus_pickaxe")
	public static final Item block = null;
	public CactusPickaxeItem(ImmersiveMinecraftModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		}, 1, -1f, new Item.Properties().group(IMcombotItemGroup.tab)) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("\u00A72\u4ED9\u4EBA\u638C\u5F88\u8F7B\uFF0C\u8010\u4E45\u4F4E\u3002"));
			}
