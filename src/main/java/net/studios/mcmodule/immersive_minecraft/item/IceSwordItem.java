...
public class IceSwordItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:ice_sword")
	public static final Item block = null;
	public IceSwordItem(ImmersiveMinecraftModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		}, 3, -2f, new Item.Properties().group(IMcombotItemGroup.tab)) {
			@Override
