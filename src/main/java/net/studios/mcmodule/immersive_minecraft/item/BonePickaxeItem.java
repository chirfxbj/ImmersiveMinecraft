...
public class BonePickaxeItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:bone_pickaxe")
	public static final Item block = null;
	public BonePickaxeItem(ImmersiveMinecraftModElements instance) {
		super(instance, 8);
	}
