...
public class FlintAxeItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:flint_axe")
	public static final Item block = null;
	public FlintAxeItem(ImmersiveMinecraftModElements instance) {
		super(instance, 17);
	}
