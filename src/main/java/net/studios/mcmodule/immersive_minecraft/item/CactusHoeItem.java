...
public class CactusHoeItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:cactus_hoe")
	public static final Item block = null;
	public CactusHoeItem(ImmersiveMinecraftModElements instance) {
		super(instance, 13);
	}
