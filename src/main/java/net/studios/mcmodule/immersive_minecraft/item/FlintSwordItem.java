...
public class FlintSwordItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:flint_sword")
	public static final Item block = null;
	public FlintSwordItem(ImmersiveMinecraftModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		}, 3, -3f, new Item.Properties().group(IMcombotItemGroup.tab)) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(
						new StringTextComponent("\u00A77\u71E7\u77F3\u505A\u7684\u5251\uFF0C\u9002\u5408\u8352\u5C9B\u751F\u5B58\u4F7F\u7528\u3002"));
			}
