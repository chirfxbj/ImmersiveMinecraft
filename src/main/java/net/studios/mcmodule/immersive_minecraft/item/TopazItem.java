...
public class TopazItem extends ImmersiveMinecraftModElements.ModElement {
	@ObjectHolder("immersive_minecraft:topaz")
	public static final Item block = null;
	public TopazItem(ImmersiveMinecraftModElements instance) {
		super(instance, 58);
	}
